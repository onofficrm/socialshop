        ...
        <a href="<?php echo G5_URL; ?>" class="flex items-center gap-2.5 group">
            ...
            <div>
                <div class="flex items-center gap-1.5">
                    <span class="text-lg sm:text-xl font-black text-white group-hover:text-[#D7AE66]">천안개인회생</span>
                    <span class="text-[10px] bg-[#252f44] text-[#D7AE66] px-1.5 py-0.5 rounded border border-[#D7AE66]/30 font-semibold">안심지원센터</span>
                </div>
                <p class="text-[11px] text-slate-400 font-normal">천안·아산·대전지방법원 전문 안심상담</p>
            </div>
        </a>
...
// send_aligo_sms($phone, "천안개인회생 비공개 상담신청 접수완료");
