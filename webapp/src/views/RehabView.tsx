          ...
          faqs: [
            {
              ...
              a: '전혀 가지 않습니다. 법원 서류 송달지는 신청 대리인(천안개인회생) 사무소로 지정되므로 자택이나 직장으로 우편물이 발송되지 않으며, 직장에 통보되는 법적 절차도 없습니다.',
            },
            {
        ...
        return {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: '정부24 전자문서지갑 또는 천안개인회생의 행정서류 대행 발급 서비스를 이용하시면 동사무소나 세무서에 방문하지 않고도 간편하게 서류를 취합할 수 있습니다.',
            },
          ],
        };
