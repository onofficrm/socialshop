    ...
    <div className="space-y-10 animate-fadeIn">
      ...
      <section className="bg-[#151C2C] text-white rounded-2xl p-6 sm:p-8 space-y-4">
        ...
        <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
          법원 회생위원은 최근 1~2년 동안 발생한 대출금의 사용처(생활비, 병원비, 도박/주식, 부동산 구매 등)를 엄격히 추적합니다. 이때 <strong>법리적 소명이 미흡하면 법원은 월 변제금을 강제로 상향(탕감률 축소)하거나 기각</strong>시킵니다. 천안개인회생은 수많은 보정 대응 경험을 바탕으로 의뢰인의 월 변제금이 1원이라도 불필요하게 인상되지 않도록 정밀 소명서를 직접 작성합니다.
        </p>
      </section>
    </div>
  );
