        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-xs">
            ...
            >
              ...
              <span className="text-xs font-semibold">{SITE.phone}</span>
            </a>
          </div>
        </div>
      </div>
            ...
            >
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="text-lg sm:text-xl font-black tracking-tight text-white group-hover:text-[#D7AE66] transition-colors">{SITE.brand}</span>
          ...
          >
            ...
            <div className="pt-3 border-t border-[#222E46] flex flex-col gap-2 text-xs text-slate-400">
              <div className="flex items-center justify-between">
                <span>전화문의</span>
                <a href={`tel:${SITE.phoneTel}`} className="text-[#D7AE66] font-bold">
                  {SITE.phone}
                </a>
              </div>
