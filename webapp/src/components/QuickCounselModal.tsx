        ...
        <div className="p-6">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center text-[11px] text-gray-500 space-y-2">
                <p>🔒 제출된 정보는 암호화 처리되며 신용평가기관에 일체 통보되지 않습니다.</p>
                <div className="flex items-center justify-center gap-3 pt-1">
                  <a href={`tel:${SITE.phoneTel}`} className="inline-flex items-center gap-1 text-[#151C2C] font-semibold hover:text-[#D7AE66]">
                    <Phone className="w-3.5 h-3.5 text-[#D7AE66]" />
                    {SITE.phone}
                  </a>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-[#151C2C] font-semibold hover:text-[#D7AE66]"
                  >
                    카카오톡 @희망도우미
                  </a>
                </div>
