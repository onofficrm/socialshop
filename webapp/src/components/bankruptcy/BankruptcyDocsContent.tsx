      ...
      <section className="bg-[#151C2C] text-white rounded-2xl p-6 sm:p-8 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-bold text-white">
            과거 서류 찾기가 막막하신가요? 천안개인회생이 전 과정을 도와드립니다
          </h3>
        </div>
        <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
          오래전 폐업한 사업장 서류나 흩어져 있는 금융기관 부채내역을 혼자서 일일이 발급받는 것은 큰 스트레스입니다. <strong>천안개인회생의 행정 전담팀이 위임장을 통해 금융기관 부채증명서 및 정부 서류를 원스톱으로 무료 대행 발급</strong>해 드립니다.
        </p>
      </section>
    </div>
  );
