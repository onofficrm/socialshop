...
export const BankruptcyProcessContent: React.FC = () => {
  const steps = [
    ...
    },
    {
      ...
      clientTask: '관재인 사무소 면담 출석 (천안개인회생 사전 코칭 제공)',
    ...
    <div className="space-y-10 animate-fadeIn">
      ...
      <section className="bg-[#151C2C] text-white rounded-2xl p-6 sm:p-8 space-y-4">
        ...
        <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
          파산관재인은 채무자가 숨겨둔 재산이 있는지, 과거에 가족에게 부동산이나 예금을 증여한 내역이 있는지 현미경처럼 들여다봅니다. <strong>소명이 불분명하면 관재인이 환가 배당을 요구하거나 면책 불허가 의견을 법원에 제출</strong>할 수 있습니다. 천안개인회생은 사건 접수 전부터 모든 금융 거래내역을 사전 전수 검토하여 관재인의 예상 질문에 대한 답변서와 증빙자료를 미리 구축합니다.
        </p>
      </section>
    </div>
  );
