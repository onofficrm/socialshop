    ...
    <div className="space-y-10 animate-fadeIn">
      ...
      <section className="bg-[#151C2C] text-white rounded-2xl p-6 sm:p-8 space-y-4">
        ...
        <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
          '파산선고'는 채무자가 빚을 갚을 능력이 없음을 법원이 공식 선언하는 것일 뿐, 채무가 사라지는 것이 아닙니다. 빚을 완전히 탕감받으려면 법원으로부터 <strong>'면책 허가 결정'</strong>을 받아야 합니다. 면책을 받지 못하면 파산자의 신분적 불이익만 남게 되므로, 천안개인회생 도산전담팀은 면책불허가 사유를 사전에 철저히 검토하여 면책까지 책임지고 완주합니다.
        </p>
      </section>
    </div>
  );
